...
export default function AboutPage() {
  return (
    <MainLayout>
      <ContainerLayout className="bg-white min-h-screen">
        <div className="max-w-4xl mx-auto py-8 bg-white">
          <h1 className="text-3xl font-bold mb-8 text-neutral-900">About Us</h1>
          
          <div className="prose prose-lg max-w-none space-y-6 prose-headings:text-neutral-900 prose-p:text-neutral-700">
            ...
            <h2 className="text-2xl font-bold mt-12 mb-6 text-neutral-900">THE TEAM</h2>
